...
document.body.style.background = " linear-gradient(to bottom, #ffffcc 0%, #ffffcc 100%)";
export default function CountdownTimer() {
    ...
    return (
        <div>
            {showEndScreen.show && (
                <h1 className="title  text-lg">{showEndScreen.message}</h1>
            )}
            <Timer
